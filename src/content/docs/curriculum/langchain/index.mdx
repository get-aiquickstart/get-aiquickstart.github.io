...
> **Example Code**
>
> Examples from this module can be found on [GitHub](https://github.com/get-aiquickstart/aiquickstart-examples/tree/main/06_langchain)
